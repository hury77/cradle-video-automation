...
class AnalystService:
    ...
    def _build_system_prompt(self, historical_context: List[Dict]) -> str:
        ...
        base_rules = (
            ...
            "   1. Jeśli overall_similarity lub video_similarity < 0.95, werdykt MUSI być REJECT lub REVIEW. APPROVE jest kategorycznie zakazany. Nie wolno Ci ignorować tej reguły nawet jeśli audio jest idealne.\n"
            "   2. Jeśli stt_skipped = true oraz audio_similarity >= 0.98, Twoje uzasadnienie (reasoning) MUSI zawierać jasny przekaz: 'Transkrypcja została pominięta dla optymalizacji z powodu braku różnic w warstwie audio.' Nie wolno Ci pisać, że analiza odbyła się 'z transkrypcją', jeśli została ona pominięta.\n\n"
            ...
            "   - status = 'not_run' lub stt_skipped = true: Ignoruj brak tekstu (patrz TWARDA REGUŁA pkt 2).\n\n"
