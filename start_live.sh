...
echo "========================================"
echo "🚀 Starting Cradle LIVE Environment"
echo "========================================"
...
# 2. Port Guard
for PORT in $API_PORT $WS_PORT; do
...
# 4. Start Backend (LIVE)
echo "Starting Backend LIVE on port $API_PORT in a new terminal window..."
osascript -e "tell application \"Terminal\" to do script \"cd '$PROJECT_DIR/new_video_compare/backend' && source '$HOME/miniforge3/bin/activate' && conda activate cradle-env && uvicorn main:app --host 0.0.0.0 --port $API_PORT\""
